...
vim.keymap.set('n', '<leader>h', vim.cmd.nohlsearch, { desc = 'Clear search highlights' })
...
vim.keymap.set('v', 'K', "<Esc><cmd>m '<-2<CR>gv=gv")
vim.keymap.set('v', 'J', "<Esc><cmd>m '>+1<CR>gv=gv")
